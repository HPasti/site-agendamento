...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($email && $nome && $escola) {
        ...
        if ($check->fetch()) {
            ...
            // CORREÇÃO #2: incluir role='diretor' e primeiro_acesso=1
            $stmt = $pdo->prepare("
...
<title>Cadastrar Gestor - Agenda Escolar</title>
<style>
:root{
  --blue:#2b6fb3;
  --blue-dark:#1a365d;
...
<section class="hero">
  <div class="hero-left">
    <img src="assets/img.png" alt="Cadastro Gestor">
  </div>
  <div class="hero-right">
    ...
    <form method="POST">
      ...
      <button class="btn-primary" type="submit">Cadastrar Gestor</button>
    </form>
  </div>
</section>
</main>
...
<div id="popup" style="position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.6);display:flex;justify-content:center;align-items:center;z-index:1000;">
  <div style="background:#fff;padding:30px;border-radius:12px;text-align:center;max-width:360px;box-shadow:0 8px 30px rgba(0,0,0,0.25);">
    <h2 style="margin-bottom:12px;color:#1a365d;">Gestor Cadastrado!</h2>
